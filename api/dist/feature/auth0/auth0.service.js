...
exports.createAuth0User = exports.addMemberToAuth0Org = exports.createAuth0Org = exports.inviteOrgMember = void 0;
const axios_1 = __importDefault(require("axios"));
const globals_1 = require("../../config/globals");
const app_error_1 = require("../../errors/app-error");
const inviteOrgMember = async ({ inviterName, inviteeEmail, authProviderOrganizationId, }) => {
    try {
